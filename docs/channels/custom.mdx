...
Cold-start sends wait until the winning session owns the address and its streams
and initial state are ready. If simultaneous sends race, eve forwards the losing
