...
no-active status. Cancel and reset wait for settlement; compact and clear return
once their candidates are accepted and report their outcomes on the stream. Authenticate and deduplicate command webhooks before
