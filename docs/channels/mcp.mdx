...
- `completed`: the agent's turn settled. Consume the optional `result`: the structured value when you passed `outputSchema`, otherwise the final assistant message.
