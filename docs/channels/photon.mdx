...
steers the active turn. Steering can interrupt pending model generation before
answer output or local tool execution begins. Executing tools finish first;
