...
To aggregate root and subagent activity without adding progress messages to the model conversation, opt into compact status, durable activity, or both:
