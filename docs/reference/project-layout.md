...
| `sandbox/workspace/**`                                  | Files hydrated into the sandbox             | Yes       | Captured under `/workspace/...` in the exported sandbox template.                                                                                                                                                     |
...
- `agent/sandbox/workspace/**` → `/workspace/...` during exported template preparation
