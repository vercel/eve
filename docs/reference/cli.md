...
```bash
eve init [target] [--model <provider/model-id>] [--reasoning <effort>] [--channel-web-nextjs] [--scaffold-only]
```
...
| `--scaffold-only`      | flag   | off                        | Scaffold and install dependencies without starting development.                                                          |
