...
| `defineClientTool`                                    | `eve/tools`                                   | `agent/tools/<name>.ts`              | [Human-in-the-loop](/docs/human-in-the-loop)           |
...
| `eve/tools`                                                 | `defineTool`, `defineClientTool`, `defineDynamic`, `disableTool`, `ExperimentalWorkflow` |
