...
| `eve/tools/defaults`                                        | canonical built-in tool definitions and sentinels                                                         |
