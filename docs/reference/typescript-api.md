...
| `disableSubagent`                                     | `eve`                                         | `agent/subagents/<id>.ts` or `agent.ts` | [Subagents](../subagents)                              |
...
| Import                                                      | Holds                                                                     |
| ----------------------------------------------------------- | ------------------------------------------------------------------------- |
| `eve`                                                       | `defineAgent`, `defineRemoteAgent`, `disableSubagent`, agent config types |
