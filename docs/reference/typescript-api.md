...
| `defineRemoteAgent`                                   | `eve`                                                | Existing remote subagent declarations                                      | [Remote agents](../guides/remote-agents)               |
...
| Import                                                                      | Holds                                                                                             |
| --------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| `eve`                                                                       | `defineAgent`, `defineLocalSubagent`, `defineRemoteSubagent`, `defineDynamic`, agent config types |
