...
| `eve/tools/<name>` (`bash`, `read_file`, …)                 | one framework tool definition per subpath, as the default export                                          |
