...
`defineMcpClientConnection` or `defineOpenAPIConnection`. See [Dynamic
capabilities](/docs/guides/dynamic-capabilities#dynamic-connections) for event
scope, naming, conflicts, and durable recovery behavior.
