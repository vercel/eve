...
This step depends on Vercel Connect, which is in private beta. No Connect access? Keep the Step 3 sample dataset and read this step for the connection model. All eight tutorial steps work against the sample dataset, so you can complete the tutorial without a warehouse.
