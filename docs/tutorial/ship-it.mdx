...
The generated composer remains available during a turn. Queue is the default
for a follow-up, Steer replaces the active turn, and an **Up next** panel shows
the browser's pending submissions. Stop remains a separate action.
