...
Start with one agent. You can [add a browser app or split into an agent workspace](/docs/getting-started/project-structure) as the project grows.
...
Keep agent definitions under `agent/` and application code beside it. Read [Project Structure](/docs/getting-started/project-structure) for recommended layouts, browser-app placement, and adding a second agent. The [Agent Files reference](/docs/reference/agent-files) lists supported files, naming rules, subagent slots, and discovery diagnostics.
