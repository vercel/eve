...
This guide creates one root agent. If you need several independently addressed root agents, start with [Project Structure](./getting-started/project-structure) and create an agent workspace instead.
