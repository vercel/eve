...
| ----------------------------------------------------------------------- | -------------------------------------------------------------------------------------- |
| Choose a single root agent, an agent workspace, or declared subagents   | [Project Structure](./project-structure.mdx)                                           |
| Create and run a single-root project, or understand its agent directory | [Getting Started](./getting-started.mdx)                                               |
