...
| -------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------- |
| Organize agents, subagents, and browser application code | [Project Structure](./getting-started/project-structure.mdx)                                                                 |
...
2. [Project Structure](./getting-started/project-structure.mdx)
