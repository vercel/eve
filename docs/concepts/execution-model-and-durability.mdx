...
session when upgrading from that model. Authorization callback URLs without an
attempt ID are also unsupported; restart authorization to obtain a current URL.
