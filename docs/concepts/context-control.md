...
| ---------------------------------------------------- | --------------------------------------------------------- | -------------------------------------------------------------------------------- |
| Permanent identity, rules, or constraints            | [`instructions.md` or `instructions.ts`](../instructions) | The instructions on every model call                                             |
...
Use instructions for stable behavior that should apply throughout a session, such as the agent's role, tone, and standing constraints. Markdown is the default. Keep instructions short enough to justify including them on every model call.
