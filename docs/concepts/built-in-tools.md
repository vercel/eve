...
| ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------- |
| `bash`              | Run a shell command, with an optional timeout in seconds. Commands time out after 300 seconds by default unless the call requests a different timeout.                                                              | Sandbox       |
