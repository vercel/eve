...
| ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------- |
| `bash`              | Run a shell command, with an optional timeout in seconds. Commands time out after 300 seconds by default; requested timeouts are capped at 600 seconds.                                                             | Sandbox       |
