...
| `experimental` | `AgentExperimentalDefinition`           | unset            | Unstable opt-ins. The `workflow` object configures the Workflow SDK runtime: `world`, `modelCallsPerStep`, and `retention`.                                                                              |
