...
Local `eve dev` makes the bundled `self-modification__agent` subagent available by default. See [Self-Modification](/docs/guides/self-modification) for its local and production behavior.
