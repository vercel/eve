...
For several independently addressed agents in one project, see [Multiple Root Agents](./getting-started/multiple-root-agents).
...
| Organize several independently addressed root agents               | [Multiple Root Agents](/docs/getting-started/multiple-root-agents)                                               |
