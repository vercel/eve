...
matches an option or the request allows free text. A question a subagent asks counts as a pending
question too, and plain text answers it by the same rule.
