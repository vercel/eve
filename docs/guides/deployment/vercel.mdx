...
An agent workspace contains several independently addressed root agents. Create and manage that layout as described in [Project Structure](../../project-structure).
