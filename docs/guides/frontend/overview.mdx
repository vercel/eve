...
If the inbox is still starting, the client retries `409 session_not_ready` up to three times
with delays of 250 ms, 500 ms, and 1 second. Stream events are not a prerequisite for sending.
