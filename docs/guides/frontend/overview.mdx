...
To scaffold a Web Chat application or choose an arrangement for one or several root agents, see [Add a Web App](./add-a-web-app).
...
The framework pages walk through the wiring step by step: [Next.js](./nextjs), [Nuxt](./nuxt), and [SvelteKit](./sveltekit). See [Add a Web App](./add-a-web-app) first when you need to choose the application arrangement.
...
- [Add a Web App](./add-a-web-app): choose a browser application arrangement
