...
authorization updates, and turns started elsewhere all update the same projection. A turn settling
does not close the connection. The transport reconnects from its cursor after a disconnect or the
