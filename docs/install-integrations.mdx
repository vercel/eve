...
Web Chat installs a project-level Next.js application. It cannot be added to an eve agent workspace; eve rejects the installation before writing files. See [Project Structure](./getting-started/project-structure) for browser-app placement and [Next.js](./guides/frontend/nextjs) for manual integration.
