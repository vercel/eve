...
Install integrations from eve's official catalog, a third-party source, or an item URL. Integrations are distributed using the [shadcn registry format](https://ui.shadcn.com/docs/registry).
