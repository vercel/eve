...
| owner.approval.candidate.coalesce-responder             | Planned | Same-responder duplicate delivery fixture                                                                      | Candidate cardinality                                         |
| owner.approval.candidate.open-distinct-responders       | Planned | Two-responder candidate fixture                                                                                | Concurrent candidate admission                                |
| owner.approval.candidate.reject                         | Planned | `responder-gate` fixture                                                                                       | Rejected candidate event                                      |
| owner.approval.candidate.fail                           | Planned | Throwing/timeout response-authorizer fixture                                                                   | Deterministic authorizer failure                              |
| owner.approval.candidate.expire                         | Blocked | Candidate expiry is durable but no timer-driven eval seam                                                      | Deterministic candidate clock                                 |
| owner.approval.response.reject-unauthorized             | Planned | `responder-gate` fixture                                                                                       | Target lifecycle events                                       |
...
| owner.approval.response.settle-cancel                   | Partial | `../hitl/authorized-response-oauth-cancel.eval.ts`                                                             | Target lifecycle events                                       |
| owner.approval.candidate.callback-rerun-authorizer      | Partial | `../hitl/authorized-response-oauth.eval.ts`                                                                    | Candidate identity and target lifecycle events                |
| owner.approval.response.settle-race                     | Planned | Two-responder candidate fixture                                                                                | Deterministic concurrent delivery                             |
| owner.approval.candidate.stale-after-winner             | Planned | Two-responder candidate fixture                                                                                | Deterministic concurrent delivery                             |
| owner.approval.response.reject-policy-failed            | Planned | Throwing/timeout response-authorizer fixture                                                                   | Deterministic authorizer failure                              |
| owner.approval.response.reject-invalid                  | Planned | `interaction/interpret.test.ts`                                                                                | Invalid-value result                                          |
| owner.approval.response.pend-authorization              | Partial | `../hitl/authorized-response-oauth.eval.ts`                                                                    | Target lifecycle events                                       |
| owner.approval.response.settle-cancel-pending-candidate | Partial | `../hitl/authorized-response-oauth-cancel.eval.ts`                                                             | Stale callback event and target lifecycle events              |
