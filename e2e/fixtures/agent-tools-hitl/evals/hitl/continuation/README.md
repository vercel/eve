...
| Approve A and answer a later question in one delivery while B waits      | Resolve both responses and deliver both replies in one completed turn                    | [approval and question](./approval-and-question.eval.ts)             |
