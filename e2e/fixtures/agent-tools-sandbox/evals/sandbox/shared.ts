...
/** Written by `template.prepare()` into the reusable template snapshot. */
export const TEMPLATE_PREPARE_MARKER_PATH = "/workspace/smoke-marker.txt";
export const TEMPLATE_PREPARE_MARKER_TOKEN = "sandbox-template-prepare-ok-J3Q";

/** Custom CLI installed on the PATH by `template.prepare()`. */
export const SANDBOX_CLI_NAME = "eve-greet";
export const SANDBOX_CLI_TOKEN = "eve-greet-cli-ok-R7M";

/** Written by the sandbox definition into each live session (not the template). */
export const SESSION_MARKER_PATH = "/workspace/session-marker.txt";
export const SESSION_MARKER_TOKEN = "sandbox-session-setup-ok-X5T";
