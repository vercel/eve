...
export const EVE_STREAM_DEFERRED_TAIL_INDEX = "deferred";
export const EVE_STREAM_TAIL_INDEX_CONTROL = "stream-tail-index";
export const EVE_STREAM_ERROR_CONTROL = "stream-error";
