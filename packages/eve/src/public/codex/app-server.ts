...
// The CLI owns authentication. eve never accepts or forwards a Codex credential.
...
export function createCodexAppServerSessionWithSpawn(
  ...
  return new LocalCodexAppServerSession(spawnProcess);
}
...
class LocalCodexAppServerSession implements CodexAppServerSession {
  ...
  constructor(spawnProcess: CodexAppServerSpawn) {
