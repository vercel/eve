...
/**
 * Shared input schema used by eve's default `read_file` tool and any author
...
/**
 * Shared output schema used by eve's default `read_file` tool and any author
 * tool constructed via {@link defineReadFileTool}.
 */
...
/** Input accepted by {@link defineReadFileTool}. */
export interface DefineReadFileToolInput {
  /** Optional model-facing description. */
  readonly description?: string;
}

/** Defines a file-reader tool that executes in the agent sandbox. */
...
/** eve's canonical default file-reader definition. */
