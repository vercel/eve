...
export {
  ...
  type AgentTurnContinuationContent,
  type AgentTurnContinuationFilePart,
  type AgentTurnContinuationFinishReason,
  type AgentTurnContinuationInput,
  type AgentTurnContinuationMessage,
  type AgentTurnContinuationPrompt,
  type AgentTurnContinuationResolver,
  type AgentTurnContinuationResult,
  type AgentTurnContinuationStep,
