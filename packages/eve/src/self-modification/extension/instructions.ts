...
const developmentMarkdown = `${introduction}
...
const developmentInstructions = defineInstructions({ markdown: developmentMarkdown });
...
export default defineDynamic({
  events: {
    "session.started": (event) => {
      ...
      if (trace === undefined) return developmentInstructions;
