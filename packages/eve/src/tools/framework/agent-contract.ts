...
export const AGENT_TOOL_DESCRIPTION = [
  "Call a registered destination or continue or steer a previous delegation with `agentId`. From a root session, omit `agentId` to delegate to a new copy of yourself.",
