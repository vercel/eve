...
import type { AuthorizationDefinition, ConnectionPrincipal } from "#shared/connections.js";
 ...
 *    `sessionProvider` has populated `SessionKey`) and durable step
 *    boundaries where only the seed keys survive
