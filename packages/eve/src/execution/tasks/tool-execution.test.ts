...
import { backgroundToolExecutionProvider } from "#execution/tasks/background.js";
import { beginBackgroundTask } from "#execution/tasks/dispatch.js";
import { sendTaskCommand, sendTaskInboundPayload } from "#execution/tasks/runtime.js";
...
vi.mock("#execution/tasks/dispatch.js", () => ({ beginBackgroundTask: vi.fn() }));
