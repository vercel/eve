...
export function createDevelopmentWorkflowWorldPluginSource(input: {
  ...
  return [
    ...
    `import { createDevelopmentWorkflowWorld, negotiateDevelopmentWorkflowWorld } from ${stringifyEsmImportSpecifier(developmentWorldImportSpecifier)};`,
    "",
    "const world = createDevelopmentWorkflowWorld();",
    "await negotiateDevelopmentWorkflowWorld(world);",
    "setWorld(world);",
    "await getWorld();",
    "",
