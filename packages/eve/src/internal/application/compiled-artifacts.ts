...
export interface GeneratedCompiledArtifactsFiles {
  ...
  /** Nitro plugin that installs the selected upstream Workflow world package. */
...
export function createWorkflowWorldPluginSource(
  ...
  const importSpecifier =
    configuredWorld === undefined ? resolvePackageDependencyPath(packageName) : packageName;
  const workflowRuntimeImportSpecifier = resolvePackageDependencyPath("@workflow/core/runtime");

  return [
    "// Generated by eve. Do not edit by hand.",
    `import * as workflowWorldModule from ${stringifyEsmImportSpecifier(importSpecifier)};`,
    `import { createWorldFromModule, setWorld } from ${stringifyEsmImportSpecifier(workflowRuntimeImportSpecifier)};`,
    "",
    "setWorld(await createWorldFromModule(workflowWorldModule));",
    "",
