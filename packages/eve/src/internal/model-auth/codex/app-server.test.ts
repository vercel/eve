...
import { createCodexAppServerSessionWithSpawn } from "#internal/model-auth/codex/app-server.js";
...
describe("Codex app-server session", () => {
  ...
  it("fails before spawning when Codex login state is missing", async () => {
