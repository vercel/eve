...
import type { RemoteAgentStreamHeadersResolver } from "#channel/route-context.js";
 ...
 *
 * Carries the resolved compiled channel set and the per-request workflow
 * runtime. The dispatch handler walks `channels` to match the inbound request
 * against a registered URL pattern, then invokes the matched route handler.
 */
...
/**
 * Resolves the per-request channel bundle and a fresh workflow runtime.
 *
