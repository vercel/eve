...
import { getHookByToken, getWorld } from "#internal/workflow/runtime.js";
...
export async function waitForCommandHookOwner(token: string): Promise<{ readonly runId: string }> {
