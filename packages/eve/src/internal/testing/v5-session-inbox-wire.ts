// Frozen v5 receiver from 1909295868eedb4b3cf26611a960c07607e980a3.
// Keep its decoder behavior independent of future sender and receiver changes.
const SESSION_INBOX_WIRE_VERSION = 5;
...
} from "#internal/testing/historical-inbox-migration-chain.js";
import { SessionInboxWireError } from "#execution/wire/session-inbox-contract.js";
import type { SessionInboxWireV5 as SessionInboxWire } from "#execution/wire/session-inbox-wire.v5.js";
