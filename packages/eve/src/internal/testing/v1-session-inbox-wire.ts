// Frozen v1 receiver from 6fc904d48 (the first versioned inbox release).
// Keep its decoder independent of future sender and receiver changes.
const SESSION_INBOX_WIRE_VERSION = 1;
...
import type { SessionInboxWireV1 as SessionInboxWire } from "#execution/wire/session-inbox-wire.v1.js";
