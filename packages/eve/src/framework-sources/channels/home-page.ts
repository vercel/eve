/**
 * Public docs URL surfaced from the barebones home page. Keeping it in the
 * package makes the response self-contained and avoids external asset lookup.
 */
 ...
 *
 * The channel supplies the compiled runtime agent name, and the page echoes
 * the visitor's request origin into the `$ eve dev …` hint. It reads no other
 * request state.
 */
 ...
 * for tests so callers can supply a real {@link Request}.
 */
