...
const EXTENSION_CAPABILITY_CONTRACTS = {
  ...
  tool: { current: 5, supported: [1, 2, 3, 4, 5], dropped: {} },
  dynamicTool: { current: 8, supported: [1, 2, 3, 4, 5, 6, 7, 8], dropped: {} },
  connection: { current: 2, supported: [1, 2], dropped: {} },
  hook: { current: 6, supported: [1, 2, 3, 4, 5, 6], dropped: {} },
  skill: { current: 1, supported: [1], dropped: {} },
  dynamicSkill: { current: 5, supported: [1, 2, 3, 4, 5], dropped: {} },
  instructions: { current: 1, supported: [1], dropped: {} },
  dynamicInstructions: { current: 5, supported: [1, 2, 3, 4, 5], dropped: {} },
