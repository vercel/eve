...
const EXTENSION_CAPABILITY_CONTRACTS = {
  ...
  tool: {
    ...
    dropped: {
      ...
      55: "SandboxSession no longer exposes setNetworkPolicy; pass the configured environment to ctx.getSandbox(environment) to access network policy capabilities",
    },
  },
  dynamicTool: {
    current: 54,
