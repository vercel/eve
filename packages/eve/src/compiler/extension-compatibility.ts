...
const EXTENSION_CAPABILITY_CONTRACTS = {
  ...
  tool: {
    ...
    dropped: {
      ...
      57: "Background tasks were rewritten: agent and workflow tool calls run as detached tasks unless attached, each call has a timeout, and resumable workflow tools and agents take more input through taskId, which replaces agentId.",
    },
  },
  dynamicTool: {
    current: 55,
