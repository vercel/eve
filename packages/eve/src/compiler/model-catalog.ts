...
import { AI_GATEWAY_MODELS_CATALOG_URL, getVercelGatewayFetch } from "#internal/gateway.js";
...
async function fetchAndPersistModelCatalog(
  ...
  const response = await getVercelGatewayFetch()(AI_GATEWAY_MODELS_CATALOG_URL);
