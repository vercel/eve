...
import askQuestionTool from "#public/tools/ask-question.js";
import { ASK_QUESTION_INPUT_SCHEMA } from "#runtime/framework-tools/ask-question.js";
  ...
  it("returns malformed and schema-invalid ask_question input to the model before accepting a retry", async () => {
    ...
    const tools: ToolLoopHarnessConfig["tools"] = new Map([
      [
        "ask_question",
        {
          description: (askQuestionTool as { description: string }).description,
