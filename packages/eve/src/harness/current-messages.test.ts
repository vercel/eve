...
describe("createCurrentMessages", () => {
  ...
  it("keeps announcement order stable and ignores empty or absent values", () => {
    ...
    current.addAnnouncements({ availableSkills: "", deliveryInstruction: undefined });
