...
// The connection callback routes now live inside the framework `eve`
// channel (`packages/eve/src/public/channels/eve.ts`); these tests exercise
// the exported handlers directly.
