...
import { TASKS_NOTE_LABEL } from "#tasks/render.js";
 ...
 *
 * Skips framework-injected `[Tasks]` notes: they ride the user
...
/**
 * True when the text is a framework-injected `[Tasks]` note.
 ...
 */
export function isTasksNoteText(text: string): boolean {
  return text.startsWith(TASKS_NOTE_LABEL);
}
