 ...
 *
 * Public connection definitions, connection-backed tools, and context
 * providers depend on these contracts rather than a protocol-specific client.
 */
...
export interface ConnectionRegistry {
  ...
  getConnections(): readonly RegisteredConnectionDefinition[];
}

/** Runtime-resolved connection fields needed by protocol-agnostic consumers. */
export interface RegisteredConnectionDefinition {
