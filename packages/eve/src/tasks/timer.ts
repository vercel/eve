...
// One sleeper run per owner. It signals the owner's stable inbox, so it
// survives handoff, and every signal is re-evaluated against the task table,
// so a stale or duplicate timer is harmless.
