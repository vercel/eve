...
- [Tasks](${EVE_ORIGIN}/docs/concepts/tasks.md): Understand waited and background agent and workflow tool calls, detach, cancellation, time limits, \`task.*\` events, and the recorded conformance streams.
