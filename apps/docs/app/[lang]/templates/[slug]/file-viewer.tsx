  ...
  return (
    <div className="grid overflow-hidden rounded-lg border border-gray-alpha-400 bg-background-100 md:grid-cols-[200px_minmax(0,1fr)]">
      <nav
        ...
        className="border-gray-alpha-400 border-b p-1 md:border-r md:border-b-0 md:p-3"
      >
        <p className="px-1 pb-0.5 text-gray-800 text-label-13-mono md:px-2 md:pb-2">agent/</p>
              ...
              return (
                <li key={node.key}>
                  <button
                    ...
                    className={cn(
                      "flex min-h-8 w-full touch-manipulation items-center gap-2 rounded-sm px-1 text-left font-mono text-[13px] leading-none outline-none transition-colors focus-visible:ring-2 focus-visible:ring-blue-700 motion-reduce:transition-none md:min-h-7 md:px-2",
                      isSelected
                      ...
                      return (
                        <li key={entry.file.relativePath}>
                          <button
                            aria-pressed={isSelected}
                            className={cn(
                              "min-h-8 w-full touch-manipulation truncate rounded-sm px-1 text-left font-mono text-[13px] leading-none outline-none transition-colors focus-visible:ring-2 focus-visible:ring-blue-700 motion-reduce:transition-none md:min-h-7 md:px-2",
                              isSelected
                                ? "font-medium text-gray-1000"
