    ...
    <section className="px-4 py-24">
      <div className="mx-auto flex max-w-5xl flex-col gap-6 lg:gap-8">
        <h2 className="mx-auto max-w-2xl text-center text-heading-32 text-gray-1000 text-balance sm:text-heading-40">
          ...
          <br className="hidden sm:block" /> Deploy it anywhere.
        </h2>
        ...
        <div className="relative isolate flex min-h-[360px] items-center justify-center overflow-visible lg:min-h-[420px] lg:overflow-hidden">
          <div className="absolute inset-x-0 top-1/2 hidden -translate-y-[90px] grid-cols-2 lg:grid">
...
function AgentCard({
  ...
  return (
    <article
      className={cn(
        "rounded-2xl border bg-background-100 p-5",
        showConnections ? "min-h-52" : "h-44 overflow-hidden",
        className,
      )}
    >
      ...
      <div className="relative mt-4">
        <span aria-hidden className="absolute right-full text-copy-16 text-gray-1000">
          “
        </span>
        <p className="line-clamp-3 text-copy-16 text-gray-1000">{agent.prompt}”</p>
      </div>
      {showConnections ? (
