...
export fn shade_glass(
  ...
  let clearcoatSample = env_reflection_from_dir(studioCube, studioSampler, reflected);
  ...
  let baseSample = env_reflection_from_dir(studioCube, studioSampler, transmissionDir);
